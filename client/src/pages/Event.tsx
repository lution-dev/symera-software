        ...
        {useState(() => {
          ...
          return (
            <>
              ...
              <div className="w-full sm:w-[260px] flex-shrink-0 mb-4 sm:mb-0 sm:border-r sm:pr-4">
                <nav className="flex flex-row sm:flex-col space-x-2 sm:space-x-0 sm:space-y-2 overflow-x-auto sm:overflow-visible">
                  <button 
                    ...
                    id="nav-tasks"
                    className={`nav-button flex justify-start items-center w-full px-3 py-2 rounded-md ${activeTab === 'tasks' ? 'bg-muted text-primary font-medium' : 'hover:bg-muted hover:text-primary'}`}
                  >
                  ...
                  <button 
                    ...
                    id="nav-team"
                    className={`nav-button flex justify-start items-center w-full px-3 py-2 rounded-md ${activeTab === 'team' ? 'bg-muted text-primary font-medium' : 'hover:bg-muted hover:text-primary'}`}
                  >
                  ...
                  <button 
                    ...
                    id="nav-timeline"
                    className={`nav-button flex justify-start items-center w-full px-3 py-2 rounded-md ${activeTab === 'timeline' ? 'bg-muted text-primary font-medium' : 'hover:bg-muted hover:text-primary'}`}
                  >
                  ...
                  <button 
                    ...
                    id="nav-activity"
                    className={`nav-button flex justify-start items-center w-full px-3 py-2 rounded-md ${activeTab === 'activity' ? 'bg-muted text-primary font-medium' : 'hover:bg-muted hover:text-primary'}`}
                  >
              ...
              {/* Coluna direita - Apenas o conteúdo ativo */}
